      ...
      <main className="space-y-6 px-4 py-6 pb-24">
        ...
        <section className="rounded-card border border-border bg-surface p-4">
          ...
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className="text-display tabular-nums flex-1 text-center">
              12
            </span>
            <button
              type="button"
          ...
          <button
            type="button"
            className="h-touch-primary w-full rounded-button bg-accent text-title font-semibold text-on-accent active:bg-accent-press"
          >
            Boton primario · 56 px
          </button>
        </section>
      </main>
