...
**Fase 1 — Entrenamiento, en curso.** Importador de Excel, calendario semanal, detalle de ejercicio con graficas, modo entreno completo (HUD, RPE, e1RM en vivo, copiar ultima sesion) y exportador a Excel ya construidos. Rediseno visual completo el 18/09/2026 (D28-D30, ver `design.md`). Desde el 19/09/2026 Entreno son **tres pantallas** —resumen del dia, modo entreno y sesion en curso— y salir del modo entreno con la flecha no lo termina (D31); la pantalla **no calcula metricas**: lo que ensena viene del Excel o es un recuento (D32). **Sigue sin cumplirse el criterio que manda sobre todos los demas**: probar el modo entreno en el gimnasio, con el dedo, en una sesion real. Nada de lo construido despues invalida esa prueba pendiente. Ver `docs/estado.md`.
